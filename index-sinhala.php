...
<title>Font Testing Page - Sinhala Version</title>
...
<script src="includes/sinhala/constants-sinhala.js" type="text/javascript" charset="utf-8"></script>
...
<section id="custom">
	...
	<div class="tabs">
	  ...
	  <ul class="tabNavigation">
	    ...
	    <li><a href="#sinhalatext">Sinhala</a></li>
	    <li><a href="#silatext">Sinhala + Latin</a></li>
      <li><a href="#sitatext">Sinhala + Tamil</a></li>
	  ...
	  <!-- Layout -->
	  <div id="layout">
	  	<?php include("includes/sinhala/layout.php"); ?>						
	  </div>
